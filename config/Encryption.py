...
# def get_key(env_var):
#     key_hex = os.getenv(env_var, "").strip()
#     # print(f"{env_var}:", key_hex)  # Debugging output
#     if not key_hex:
#         raise ValueError(f"Missing {env_var} in .env file")
#     try:
#         return bytes.fromhex(key_hex)  # Convert HEX to bytes
...
# # Load encryption key
# KEY = get_key("KEY1")  # Use a single key for encryption and decryption
# SALT = get_key("SALT")
...
#     # Decode the Base64-encoded hash into bytes
#     derived_key = base64.b64decode(raw_hash_base64)
#     # print("Derived Key:", derived_key.hex())  # Debugging output
#     return derived_key
...
# # Encrypt Password (Single Layer)
# def encrypt_pass(password: str) -> str:
#     derived_key = derive_key()
#     encrypted = aes_encrypt(password, derived_key)
#     # print("Encrypted:", encrypted)  # Debugging output
#     return encrypted

# # Decrypt Password (Single Layer)
# def decrypt_pass(encrypted_data: str) -> str:
#     derived_key = derive_key()
#     decrypted = aes_decrypt(encrypted_data, derived_key)
#     # print("Decrypted:", decrypted)  # Debugging output
#     return decrypted
